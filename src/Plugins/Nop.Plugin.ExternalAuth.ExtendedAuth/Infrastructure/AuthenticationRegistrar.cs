...
namespace Nop.Plugin.ExternalAuth.ExtendedAuthentication.Infrastructure
{
    ...
    public class AuthenticationRegistrar : IExternalAuthenticationRegistrar
    {
        ...
        //    // get detail into user class
        //    SocialUser user = JsonConvert.DeserializeObject<SocialUser>(await response.Content.ReadAsStringAsync(), new ExpandoObjectConverter());
        //    context.Identity.AddClaim(new Claim(ClaimTypes.NameIdentifier, context.Options.ClaimsIssuer));
        //    context.Identity.AddClaim(new Claim(ClaimTypes.Name, context.Options.ClaimsIssuer));
        ...
        //    else if (!string.IsNullOrEmpty(user.given_name))
        //        firstName = user.given_name;
        //    else if (!string.IsNullOrEmpty(user.screen_name))
        //        firstName = user.screen_name;
        //    context.Identity.AddClaim(new Claim(ClaimTypes.GivenName, firstName)); name = firstName + "_";
        ...
        //    context.Identity.AddClaim(new Claim(ClaimTypes.Surname, lastName)); name = name + lastName;

        //    //set email                      
        //    if (string.IsNullOrEmpty(user.email))
        //    {
        //        user.email = name.Replace(" ", "");
        //        user.email = user.email + "@" + context.Options.ClaimsIssuer + ".com";
        //    }
