...
using Nop.Plugin.DiscountRules.CustomerRoles;
using Nop.Services.Configuration;
using Nop.Services.Events;

namespace Nop.Plugin.DiscountRules.PartialPayment.Infrastructure.Cache
{
    /// <summary>
    ...
    public partial class DiscountRequirementEventConsumer : IConsumer<EntityDeletedEvent<DiscountRequirement>>
    {
        ...
        public void HandleEvent(EntityDeletedEvent<DiscountRequirement> eventMessage)
        {
            ...
            var setting = _settingService.GetSetting(string.Format(PartialPaymentRequirementDefaults.SettingsKey, discountRequirement.Id));
            if (setting != null)
